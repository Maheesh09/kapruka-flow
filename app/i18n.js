...
export const STRINGS = {
  EN: {
    ...
    closeAria: 'Close',
    // ── Category rail ──
    categoryRailLabel: 'Or jump straight into a category',
    catCakes: 'Cakes',
    catFlowers: 'Flowers',
    catGrocery: 'Grocery',
    catFashion: 'Fashion',
    ...
    compareBtn: 'Compare',
    compareTitle: 'Compare your shortlist',
  ...
  SI: {
    ...
    closeAria: 'වසන්න',
    // ── Category rail ──
    categoryRailLabel: 'නැත්නම් කෙළින්ම ප්‍රවර්ගයකට යන්න',
    catCakes: 'කේක්',
    catFlowers: 'මල්',
    catGrocery: 'ගෙදර බඩු',
    catFashion: 'ඇඳුම්',
    ...
    compareLabel: 'සසඳන්න',
    compareBtn: 'සසඳන්න',
    compareTitle: 'ඔබ තෝරාගත් දේ සසඳන්න',
  ...
  TA: {
    ...
    closeAria: 'மூடு',
    // ── Category rail ──
    categoryRailLabel: 'அல்லது நேரடியாக ஒரு வகைக்குச் செல்லுங்கள்',
    catCakes: 'கேக்குகள்',
    catFlowers: 'பூக்கள்',
    catGrocery: 'மளிகைப் பொருட்கள்',
    catFashion: 'ஆடைகள்',
    catBooks: 'புத்தகங்கள்',
    catGifts: 'பரிசு தொகுப்புகள்',
    // ── Compare ──
    compareLabel: 'ஒப்பிடு',
    compareBtn: 'ஒப்பிடு',
    compareTitle: 'உங்கள் தேர்வுகளை ஒப்பிடுங்கள்',
